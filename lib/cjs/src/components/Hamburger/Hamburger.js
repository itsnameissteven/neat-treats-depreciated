...
var Hamburger = function (_a) {
    ...
    if (pipes === 2) {
        return (react_1.default.createElement("svg", { className: "hamburger ".concat(className, " ").concat(noAnimation), width: size, height: size, style: styles, onClick: onClick, viewBox: "0 0 48 48", fill: "none", xmlns: "http://www.w3.org/2000/svg" },

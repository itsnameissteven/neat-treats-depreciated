...
var Input = function (_a) {
    ...
    var _b = (0, react_1.useState)(0), legendWidth = _b[0], setLegendWidth = _b[1];
    var _c = (0, react_1.useState)(false), isInFocus = _c[0], setIsInFocus = _c[1];
    ...
    var fieldSetClass = (0, classnames_1.default)('neat-input', "".concat(className), {
        'neat-input__error': !!errorMessage,
    });
    var width = isInFocus || value.length ? "".concat(legendWidth, "px") : '0px';
    return (react_1.default.createElement("fieldset", { className: fieldSetClass },
        ...
        !!errorMessage && (react_1.default.createElement("p", { className: "neat-input__error-msg" }, errorMessage))));
};

...
var Glitter = function (_a) {
    var _b = _a.color, color = _b === void 0 ? "#FFC700" : _b, _c = _a.rainbow, rainbow = _c === void 0 ? false : _c, children = _a.children, delegated = __rest(_a, ["color", "rainbow", "children"]);
    var _d = react_1.useState(function () {
        return range_1.default(3).map(function () { return generateSparkle_1.default(color); });
    }), sparkles = _d[0], setSparkles = _d[1];
    var prefersReducedMotion = usePrefersReducedMotion_1.default();
    useRandomInterval_1.default(function () {
        var now = Date.now();
        var newColor = rainbow ? randomcolor_1.default() : color;
        var sparkle = generateSparkle_1.default(newColor);
    ...
    }, prefersReducedMotion ? null : 50, prefersReducedMotion ? null : 500);

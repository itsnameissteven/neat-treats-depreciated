...
var Carousel = function (_a) {
    ...
    var _g = (0, react_1.useState)(1), activeIndex = _g[0], setActiveIndex = _g[1];
    var _h = (0, react_1.useState)(false), isDisabled = _h[0], setIsDisabled = _h[1];
    var _j = (0, react_1.useState)(false), isNoTransition = _j[0], setIsNoTransition = _j[1];
    ...
    return (react_1.default.createElement("div", { className: "carousel" },
        ...
        react_1.default.createElement("div", { onTransitionEnd: resetlocation, className: slideClass, style: {

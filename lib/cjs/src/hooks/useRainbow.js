...
var useRainbow = function (_a) {
    ...
    var uniqueId = (0, react_1.useRef)((0, generateId_1.default)()).current;
    (0, react_1.useEffect)(function () {
        if (!isEnabled) {
            return;
        }
        (0, range_1.default)(0, WINDOW_SIZE).map(function (index) {
    ...
    var intervalCount = (0, useIncrementingNumber_1.default)(intervalDelay);
    return (0, range_1.default)(0, WINDOW_SIZE).reduce(function (acc, index) {
        var _a;

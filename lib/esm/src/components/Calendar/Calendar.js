...
var Calendar = function () {
    ...
    var renderDaysOfWeek = function () {
        return daysOfWeek.map(function (day, i) {
            return (React.createElement("p", { className: "calendar__day-of-week__name", key: i }, day));
        });
    };
    ...
    var renderDays = function () {
        ...
        var renderDay = function (_a) {
            ...
            return (React.createElement("div", { className: "cells__day", key: "".concat(key, "-").concat(i) },
                React.createElement("div", { className: activeDayContainerClass(dayValue, cells.length + 1) },
                    React.createElement("button", { className: activeDayClass(dayValue, out), onClick: function () { return handleDateClick(dayValue); } }, altDate ? altDate.toString() : i.toString()))));
        };
        ...
        return React.createElement("div", { className: "cells" }, cells);
    };
    return (React.createElement("div", { className: "calendar" },
        React.createElement("div", { className: "calendar__header" },
            React.createElement("button", { onClick: onPrevMonth },
                React.createElement(Icon, { name: "chevron-left", size: 24 })),
            React.createElement("p", { className: "calendar__header__month" },
                monthStr,
                " ",
                year),
            React.createElement("button", { onClick: onNextMonth },
                React.createElement(Icon, { name: "chevron-right", size: 24 }))),
        React.createElement("div", { className: "calendar__day-of-week" }, renderDaysOfWeek()),
        renderDays()));
};

...
var Icon = function (_a) {
    ...
    var CreatedItem = function (_a) {
        var props = __rest(_a, []);
        return React.createElement(Component, __assign({ size: size, color: color, className: className }, props));
    };
    if (onClick) {
        return (React.createElement("button", { onClick: onClick, className: classNames(className), disabled: disabled },
            React.createElement(CreatedItem, { className: null })));
    }
    return React.createElement(CreatedItem, null);
};
export default Icon;

...
var Spacer = function (_a) {
    ...
    return (React.createElement("span", __assign({ style: __assign({ display: "block", width: width, minWidth: width, height: height, minHeight: height, backgroundColor: color, borderRadius: isRounded ? "50px" : "0px" }, style) }, delegated)));
};

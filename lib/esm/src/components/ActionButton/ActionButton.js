...
var ActionButton = function (_a) {
    ...
    return (React.createElement("button", { className: "action-btn ".concat(className), onClick: onClick },
        ...
        React.createElement("div", { className: "action-btn__content ".concat(animationClass, " ").concat(noAnimation) }, children ? children : React.createElement(Icon, { name: iconName || "", size: size * 0.6 }))));
};

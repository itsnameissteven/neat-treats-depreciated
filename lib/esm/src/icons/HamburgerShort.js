...
var HamburgerShort = function (_a) {
    ...
    return (React.createElement("svg", __assign({ width: size, height: size, viewBox: "0 0 48 48", fill: "none", xmlns: "http://www.w3.org/2000/svg" }, props),
        React.createElement("rect", { x: "2", y: "14", width: "44", height: "6", rx: "3", fill: color }),
        React.createElement("rect", { x: "2", y: "28", width: "44", height: "6", rx: "3", fill: color })));
};
